...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'h1': ['4rem', { lineHeight: '1.5', fontWeight: 'bold' }],
        'h2': ['50px', { lineHeight: '1.2', fontWeight: 'bold' }],
        'h3': ['36px', { lineHeight: '1.2', fontWeight: 'bold' }],
        'regular': ['20px', { lineHeight: '1.5', fontWeight: 'normal' }],
        'bold-20': ['20px', { lineHeight: '1.5', fontWeight: 'bold' }],
        'semibold-20': ['20px', { lineHeight: '1.5', fontWeight: '600' }],
      },
    },
  },
  plugins: [],
