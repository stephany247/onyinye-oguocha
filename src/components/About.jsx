...
function About() {
  return (
    <section className="w-full bg-light-purple py-24 flex items-center justify-center" id="about-section">
      <div className="max-w-screen-lg px-auo grid md:grid-cols-2 grid-rows-2 gap-12 mx-8 md:gap-y-16 md:gap-x-12 text-center md:text-left">
        <div className="md:col-start-1 md:row-start-1">
          <h1 className="text-h2 text-purple font-delius uppercase mb-12">About Me</h1>
